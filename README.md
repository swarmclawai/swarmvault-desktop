...
- **Health workbench, task ledger, and retrieval workflows** powered by SwarmVault 3.3, including full doctor details, copyable suggested commands, explicit capture modes, and budgeted agent handoffs
